...
//     );
//     assert(web3.utils.fromWei(balance5a) - web3.utils.fromWei(balance5) == 5, "balance should change by 5");
//   });
...
//     balance5a = await master.balanceOf(accounts[5])
//     assert(web3.utils.fromWei(balance5a) - web3.utils.fromWei(balance5) == 7, "balance should change by 7");
//   });
