...
contract("Request and tip tests", function(accounts) {
  ...
  it("Request data and change on queue with another request", async function() {
    ...
    assert(tips.includes(pay.add(tipBefore31).toString()), "Tipdson deck should be 31");
    assert(tips.includes(pay2.add(tipBefore32).toString()), "Tipds on deck should be 31");
