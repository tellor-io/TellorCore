...
//           }
//         }   
//         vars = await oracle.getNewCurrentVariables()
//         var oldDiff = vars[2]
...
//         assert(await oracle.getNewValueCountbyRequestId(1) == 4, "Request ID 1 should have 8 mines");
//     });
...
// 	        console.log(i)
// 	        await  web3.eth.sendTransaction({to: oracle.address,from:miners[j],gas:7000000,data:oracle2.methods.beginDispute(1,res[1],i).encodeABI()});
// 	        let disputeVars = await oracle.getAllDisputeVars(1);
// 	        let vals = await oracle.getSubmissionsByTimestamp(1,res[1]);
// 	        assert(disputeVars['0'] == web3.utils.soliditySha3({t:'address',v:miners[i]},{t:'uint256',v:1},{t:'uint256',v:res[1]}),"hash Should be correct");
...
// 	        assert(disputeVars['7'][1] == res[1], "timestamp should be correct")
...
// 	        await helper.advanceTime(86400 * 22);
// 	        await web3.eth.sendTransaction({to: oracle.address,from:accounts[0],gas:7000000,data:oracle2.methods.tallyVotes(1).encodeABI()});
// 	        assert(await oracle.isInDispute(1,res[1]) == false)
// 	     	balance2 = await oracle.balanceOf(miners[i]);
