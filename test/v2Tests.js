...
contract("v2 Tests", function(accounts) {
  ...
  it("Test zeroing out of currentTips", async function() {
    await master.addTip(1, "100000000000", { from: accounts[2] });

    await helper.advanceTime(60 * 16);
    // await TestLib.mineBlock(env);
    // console.log(
    //   await master.getUintVar(web3.utils.keccak256("currentTotalTips"))
    // );
    let tips = await master.getUintVar(
      web3.utils.keccak256("currentTotalTips")
    );
    ...
    //   await master.getUintVar(web3.utils.keccak256("currentTotalTips"))
    // );
    let tips2 = await master.getUintVar(
      web3.utils.keccak256("currentTotalTips")
    );
    console.log(tips2.toString());
    // assert(tips.eq(new BN("0")), "Tips should be zeroed ");
  });
  ...
  //        web3.utils.fromWei(dispInfo[7][8]),
  ...
  //     assert(changes[0] <= web3.utils.toWei("105", "ether"));
  //     assert(changes[1] <= web3.utils.toWei("103.5", "ether"));
  //     assert(changes[2] <= web3.utils.toWei("103.5", "ether"));
  //     assert(changes[3] <= web3.utils.toWei("103.5", "ether"));
  //     assert(changes[4] <= web3.utils.toWei("103.5", "ether"));
  //     assert(
