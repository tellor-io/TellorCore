...
//       await master.beginDispute(1, times[0], 1, { from: accounts[0] });
//       await master.beginDispute(1, times[1], 1, { from: accounts[1] });
//       await master.beginDispute(1, times[2], 1, { from: accounts[0] });
