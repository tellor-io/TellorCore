...
contract('Further Tests w/ Upgrade', function(accounts) {
  ...
  // '0': [ '44', '31', '43', '42', '41' ],
  // '1': [ '100', '20', '100', '100', '100' ],
  // idsOnDeck: [ '44', '31', '43', '42', '41' ],
  // tipsOnDeck: [ '100', '20', '100', '100', '100' ]
    ...
    it("Request data and change on queue with another request", async function () {
        ...
        data = await oracle2.methods.getNewVariablesOnDeck().call();
        assert(data[0][2] == 31, 'ID on deck should be 31');
  ...
  it("Test Add Value to Pool and change on queue", async function () {
   ...
   // });
    ...
    //  	await helper.expectThrow(web3.eth.sendTransaction({to:oracle.address,from:accounts[i],gas:7000000,data:oracle2.methods.testSubmitMiningSolution("nonce",[6,2,3,4,5],[1200,1300,1400,1500,1600]).encodeABI()}) );
    //     for(var i = 0;i<5;i++){
